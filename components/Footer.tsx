  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: (
        <FaFacebookSquare className="text-black hover:text-gray-800 transform hover:scale-110 transition-transform duration-300" />
      ),
      href: "",
    },
    {
      name: "Instagram",
      icon: (
        <FaInstagram className="text-black hover:text-gray-800 transform hover:scale-110 transition-transform duration-300" />
      ),
    ...
    },
    {
      name: "LinkedIn",
      icon: (
        <FaLinkedin className="text-black hover:text-gray-800 transform hover:scale-110 transition-transform duration-300" />
      ),
      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-between lg:justify-evenly">
          <div className="w-full lg:w-4/12 px-4 mb-8 lg:mb-0">
            ...
            <a
              href="mailto:divineinfotech.edu@gmail.com"
              className="font-medium hover:underline underline-offset-4 decoration-black hover:cursor-pointer transition-all"
            >
