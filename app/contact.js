...
const ContactServices = ({ bgColor }) => {
  ...
  return (
    <div className={`container mx-auto py-12 lg:py-10 px-6   md:px-6 lg:px-40 ${bgColor}`}>
      <h2 className="text-5xl font-semibold text-gray-800 mb-6 text-center">Let's Talk</h2>
      <motion.div
        className="bg-white p-6 rounded-xl border-2 border-gray-100 max-w-xl mx-auto"
        ref={ref2}
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-[1.1em]">
          <div>
          ...
          <button type="submit" className="w-full bg-gray-950 text-white font-bold py-3 rounded-full hover:bg-blue-700 transition-all">
            Send Message
          </button>
        </form>
      </motion.div>
